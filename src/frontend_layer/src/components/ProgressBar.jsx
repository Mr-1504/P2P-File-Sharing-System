    ...
    return (
        <div className="space-y-6">
            {tasks.length === 0 ? (
                ...
                tasks.map(task => {
                    const taskType = getTaskType(task); // ✅ Sử dụng function đã cập nhật
                        ...
                        <div key={task.id} className={`bg-white p-6 rounded-xl shadow-lg border-2 ${colors.border} ${colors.bg} transition-all duration-300 hover:shadow-xl`}>
                            ...
                            <div className="flex items-center justify-between mb-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${colors.bg} ${colors.text}`}>
                                                {statusText} {/* ✅ Sử dụng statusText đã được customize */}
                                            </span>
                                            {/* ✅ Chỉ hiển thị ETA cho download tasks */}
                                            {eta && taskType === 'downloading' && (
                                ...
                                <div className="flex space-x-2">
                                    ...
                                    {/* ✅ Resume button chỉ cho download tasks */}
                                    {taskType === 'downloading' && ((task.status === 'resumable') ||
                            ...
                            {/* ✅ Stats display dựa trên taskType */}
                            {taskType === 'sharing' ? (
                                // Layout đặc biệt cho sharing - chỉ hiển thị %
                                ...
                                // Grid layout chi tiết cho download
